...
- Downstream compacted contract consumes source-only asset source/ths__limit_up_pool.
- LowCardinality review on S3 parquet source/ths__limit_up_pool_compacted: rows=16014; reason_type nonnull=16014 uniq=11573 unique_rate=0.722680. reason_type exceeds the 10000 unique-value threshold and uses ClickHouse String. Parquet schema remains string.
