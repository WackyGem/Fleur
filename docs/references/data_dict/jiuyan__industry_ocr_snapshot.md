...
|---|----------|----------|--------------|---------------------|-----------------|----------|
| 1 | `industry_id` | `N/A` | `string` | `industry_id` | `LowCardinality(String)` | 行业研究记录标识 |
...
| 6 | `theme_path` | `array` | `string` | `theme_path` | `LowCardinality(String)` | OCR 识别出的题材或主题路径。 |
