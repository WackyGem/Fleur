...
- profiling 命令：`cd pipeline && uv run python elt/scripts/profile_raw_source.py --source raw --table eastmoney__cashflow_sq --execute --output ../docs/references/raw_profile/eastmoney__cashflow_sq.md`，并补充 ClickHouse 结构化汇总查询
- 行数：274,016
- 数据范围：`REPORT_DATE`: 2000-12-31 至 2026-03-31，NULL 0 行；`NOTICE_DATE`: 2001-03-15 至 2026-05-15，NULL 0 行；`UPDATE_DATE`: 1970-01-01 至 2026-06-02，NULL 0 行，`1970-01-01` 占位 449 行
...
| CURRENCY | LowCardinality(String) | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金流量表单季度金额使用的币种。 |
...
| SALES_SERVICES_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 销售商品、提供劳务收到的现金环比增长率（%） |
| DEPOSIT_INTERBANK_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 同业存放净增加额环比增长率（%） |
| LOAN_PBC_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 向央行借款净增加额环比增长率（%） |
| OFI_BF_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 向其他金融机构拆入资金净增加额环比增长率（%） |
| RECEIVE_ORIGIC_PREMIUM_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到原保险合同保费现金环比增长率（%） |
| RECEIVE_REINSURE_NET_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到再保险业务现金净额环比增长率（%） |
| INSURED_INVEST_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 保户储金及投资款净增加额环比增长率（%） |
| DISPOSAL_TFA_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 处置交易性金融资产净增加额环比增长率（%） |
| RECEIVE_INTEREST_COMMISSION_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收取利息和手续费现金环比增长率（%） |
| BORROW_FUND_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 拆入资金净增加额环比增长率（%） |
| LOAN_ADVANCE_REDUCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 发放贷款及垫款净减少额环比增长率（%） |
| REPO_BUSINESS_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 回购业务资金净增加额环比增长率（%） |
| RECEIVE_TAX_REFUND_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到的税费返还环比增长率（%） |
| RECEIVE_OTHER_OPERATE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到其他与经营活动有关的现金环比增长率（%） |
| OPERATE_INFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流入其他环比增长率（%） |
| OPERATE_INFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流入平衡项环比增长率（%） |
| TOTAL_OPERATE_INFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流入小计环比增长率（%） |
| BUY_SERVICES_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 购买商品、接受劳务支付的现金环比增长率（%） |
| LOAN_ADVANCE_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 发放贷款及垫款净增加额环比增长率（%） |
| PBC_INTERBANK_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 向央行借款净增加额环比增长率（%） |
| PAY_ORIGIC_COMPENSATE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付原保险合同赔付款项现金环比增长率（%） |
| PAY_INTEREST_COMMISSION_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付利息和手续费现金环比增长率（%） |
| PAY_POLICY_BONUS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 保单红利支出环比增长率（%） |
| PAY_STAFF_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付给职工以及为职工支付的现金环比增长率（%） |
| PAY_ALL_TAX_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付的各项税费环比增长率（%） |
| PAY_OTHER_OPERATE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付其他与经营活动有关的现金环比增长率（%） |
| OPERATE_OUTFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流出其他环比增长率（%） |
| OPERATE_OUTFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流出平衡项环比增长率（%） |
| TOTAL_OPERATE_OUTFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动现金流出小计环比增长率（%） |
| OPERATE_NETCASH_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动净现金流量其他环比增长率（%） |
| OPERATE_NETCASH_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动净现金流量平衡项环比增长率（%） |
| NETCASH_OPERATE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动产生的现金流量净额环比增长率（%） |
| WITHDRAW_INVEST_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收回投资收到的现金环比增长率（%） |
| RECEIVE_INVEST_INCOME_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 取得投资收益收到的现金环比增长率（%） |
| DISPOSAL_LONG_ASSET_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 处置固定资产等收回的现金净额环比增长率（%） |
| DISPOSAL_SUBSIDIARY_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 处置子公司及其他营业单位收到的现金净额环比增长率（%） |
| REDUCE_PLEDGE_TIMEDEPOSITS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 减少质押定期存款环比增长率（%） |
| RECEIVE_OTHER_INVEST_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到其他与投资活动有关的现金环比增长率（%） |
| INVEST_INFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流入其他环比增长率（%） |
| INVEST_INFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流入平衡项环比增长率（%） |
| TOTAL_INVEST_INFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流入小计环比增长率（%） |
| CONSTRUCT_LONG_ASSET_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 购建固定资产等支付的现金环比增长率（%） |
| INVEST_PAY_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资支付的现金环比增长率（%） |
| PLEDGE_LOAN_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 质押贷款净增加额环比增长率（%） |
| OBTAIN_SUBSIDIARY_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 取得子公司及其他营业单位支付的现金净额环比增长率（%） |
| ADD_PLEDGE_TIMEDEPOSITS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 增加质押定期存款环比增长率（%） |
| PAY_OTHER_INVEST_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付其他与投资活动有关的现金环比增长率（%） |
| INVEST_OUTFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流出其他环比增长率（%） |
| INVEST_OUTFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流出平衡项环比增长率（%） |
| TOTAL_INVEST_OUTFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动现金流出小计环比增长率（%） |
| INVEST_NETCASH_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动净现金流量其他环比增长率（%） |
| INVEST_NETCASH_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动净现金流量平衡项环比增长率（%） |
| NETCASH_INVEST_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资活动产生的现金流量净额环比增长率（%） |
| ACCEPT_INVEST_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 吸收投资收到的现金环比增长率（%） |
| SUBSIDIARY_ACCEPT_INVEST_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 子公司吸收少数股东投资收到的现金环比增长率（%） |
| RECEIVE_LOAN_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 取得借款收到的现金环比增长率（%） |
| ISSUE_BOND_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 发行债券收到的现金环比增长率（%） |
| RECEIVE_OTHER_FINANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 收到其他与筹资活动有关的现金环比增长率（%） |
| FINANCE_INFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流入其他环比增长率（%） |
| FINANCE_INFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流入平衡项环比增长率（%） |
| TOTAL_FINANCE_INFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流入小计环比增长率（%） |
| PAY_DEBT_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 偿还债务支付的现金环比增长率（%） |
| ASSIGN_DIVIDEND_PORFIT_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 分配股利、利润或偿付利息支付的现金环比增长率（%） |
| SUBSIDIARY_PAY_DIVIDEND_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 子公司向少数股东支付的现金股利环比增长率（%） |
| BUY_SUBSIDIARY_EQUITY_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 子公司减少现金环比增长率（%） |
| PAY_OTHER_FINANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 支付其他与筹资活动有关的现金环比增长率（%） |
| SUBSIDIARY_REDUCE_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 子公司减少现金环比增长率（%） |
| FINANCE_OUTFLOW_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流出其他环比增长率（%） |
| FINANCE_OUTFLOW_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流出平衡项环比增长率（%） |
| TOTAL_FINANCE_OUTFLOW_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动现金流出小计环比增长率（%） |
| FINANCE_NETCASH_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动净现金流量其他环比增长率（%） |
| FINANCE_NETCASH_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动净现金流量平衡项环比增长率（%） |
| NETCASH_FINANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 筹资活动产生的现金流量净额环比增长率（%） |
| RATE_CHANGE_EFFECT_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 汇率变动对现金及现金等价物的影响环比增长率（%） |
| CCE_ADD_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额其他环比增长率（%） |
| CCE_ADD_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额平衡项环比增长率（%） |
| CCE_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额环比增长率（%） |
| BEGIN_CCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 期初现金及现金等价物余额环比增长率（%） |
| END_CCE_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 期末现金及现金等价物余额其他环比增长率（%） |
| END_CCE_BALANCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 期末现金及现金等价物余额平衡项环比增长率（%） |
| END_CCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 期末现金及现金等价物余额环比增长率（%） |
...
| OTHER | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金流量表单季度补充资料中的其他项目。 |
...
| ASSET_IMPAIRMENT_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 资产减值准备环比增长率（%） |
| FA_IR_DEPR_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 固定资产折旧、油气资产折耗、生产性生物资产折旧环比增长率（%） |
| OILGAS_BIOLOGY_DEPR_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 油气资产折耗、生产性生物资产折旧环比增长率（%） |
| IR_DEPR_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 折旧与摊销环比增长率（%） |
| IA_AMORTIZE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 无形资产摊销环比增长率（%） |
| LPE_AMORTIZE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 长期待摊费用摊销环比增长率（%） |
| DEFER_INCOME_AMORTIZE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 待摊费用减少（减：增加）环比增长率（%） |
| PREPAID_EXPENSE_REDUCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 预提费用增加（减：减少）环比增长率（%） |
| ACCRUED_EXPENSE_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 预提费用变动环比增长率（%） |
| DISPOSAL_LONGASSET_LOSS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 处置固定资产等的损失环比增长率（%） |
| FA_SCRAP_LOSS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 固定资产报废损失环比增长率（%） |
| FAIRVALUE_CHANGE_LOSS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 公允价值变动损失环比增长率（%） |
| FINANCE_EXPENSE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 财务费用环比增长率（%） |
| INVEST_LOSS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 投资损失环比增长率（%） |
| DEFER_TAX_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 递延所得税资产减少（增加以"-"号填列）环比增长率（%） |
| DT_ASSET_REDUCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 递延所得税资产减少环比增长率（%） |
| DT_LIAB_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 递延所得税负债增加环比增长率（%） |
| PREDICT_LIAB_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 预计负债增加环比增长率（%） |
| INVENTORY_REDUCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 存货的减少（增加以"-"号填列）环比增长率（%） |
| OPERATE_RECE_REDUCE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营性应收项目的减少环比增长率（%） |
| OPERATE_PAYABLE_ADD_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营性应付项目的增加环比增长率（%） |
| OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 其他环比增长率（%） |
| OPERATE_NETCASH_OTHERNOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动产生的现金流量净额（附注）环比增长率（%） |
| OPERATE_NETCASH_BALANCENOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动净现金流量（附注）平衡项环比增长率（%） |
| NETCASH_OPERATENOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 经营活动产生的现金流量净额（附注）环比增长率（%） |
| DEBT_TRANSFER_CAPITAL_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 债务转为资本环比增长率（%） |
| CONVERT_BOND_1YEAR_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 一年内到期的可转换公司债券环比增长率（%） |
| FINLEASE_OBTAIN_FA_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 融资租入固定资产环比增长率（%） |
| UNINVOLVE_INVESTFIN_OTHER_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 不涉及现金收支的投资和筹资活动其他环比增长率（%） |
| END_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金期末余额环比增长率（%） |
| BEGIN_CASH_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金期初余额环比增长率（%） |
| END_CASH_EQUIVALENTS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金等价物期末余额环比增长率（%） |
| BEGIN_CASH_EQUIVALENTS_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金等价物期初余额环比增长率（%） |
| CCE_ADD_OTHERNOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额（附注）环比增长率（%） |
| CCE_ADD_BALANCENOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额（附注）平衡项环比增长率（%） |
| CCE_ADDNOTE_QOQ | Float64 | 未逐列统计 | 未逐列统计 | 保留 raw 字段；按需在具体 staging 中补充 | 现金及现金等价物净增加额（附注）环比增长率（%） |
...
- 观察到的格式：`SECUCODE`: canonical 后缀 274016/274016，供应商前缀 0/274016，纯数字 0/274016，空值 0/274016；`SECURITY_CODE`: canonical 后缀 0/274016，供应商前缀 0/274016，纯数字 274016/274016，空值 0/274016
...
- 范围：`REPORT_DATE`: 2000-12-31 至 2026-03-31，NULL 0 行；`NOTICE_DATE`: 2001-03-15 至 2026-05-15，NULL 0 行；`UPDATE_DATE`: 1970-01-01 至 2026-06-02，NULL 0 行，`1970-01-01` 占位 449 行
...
- 取值：`SECUCODE`: `600019.SH`(97), `000402.SZ`(97), `000962.SZ`(95), `600819.SH`(95), `600280.SH`(95), `600640.SH`(95), `600708.SH`(95), `000929.SZ`(95)；`SECURITY_CODE`: `600019`(97), `000402`(97), `000951`(95), `600302`(95), `000025`(95), `000410`(95), `000798`(95), `000619`(95)；`SECURITY_NAME_ABBR`: `东方明珠`(142), `百联股份`(127), `宝钢股份`(97), `金融街`(97), `*ST广糖`(95), `云维股份`(95), `国电电力`(95), `中国重汽`(95)；`ORG_CODE`: `10004127`(160), `10004106`(156), `10116535`(126), `10004293`(116), `10002266`(97), `10633808`(97), `10005578`(95), `10002608`(95)；`ORG_TYPE`: `通用`(274016)；`REPORT_TYPE`: `一季度`(71797), `三季度`(68255), `四季度`(67850), `二季度`(66114)；`REPORT_DATE_NAME`: `2026一季度`(5099), `2025一季度`(5088), `2025四季度`(5084), `2024一季度`(5073), `2025三季度`(5060), `2025二季度`(5051), `2024三季度`(5034), `2024四季度`(5020)；`SECURITY_TYPE_CODE`: `058001001`(273993), `058001008`(23)
...
- 最小/最大值：`NETCASH_OPERATE` min=-122529899000.0, max=155272000000.0, zero=33, negative=94764, NULL=0；`NETPROFIT` min=0.0, max=0.0, zero=274016, negative=0, NULL=0；`SALES_SERVICES` min=-42322221929.59, max=959495000000.0, zero=1013, negative=1420, NULL=0；`DEPOSIT_INTERBANK_ADD` min=-87592360060.9, max=102877887953.83, zero=272556, negative=622, NULL=0；`LOAN_PBC_ADD` min=-5080000000.0, max=3140000000.0, zero=273773, negative=110, NULL=0；`OFI_BF_ADD` min=-19095030043.44, max=12402359588.77, zero=273621, negative=173, NULL=0；`RECEIVE_ORIGIC_PREMIUM` min=-283791773.13, max=8374326598.0, zero=273699, negative=12, NULL=0；`RECEIVE_REINSURE_NET` min=-269841134.34, max=459643509.88, zero=273951, negative=32, NULL=0；`INSURED_INVEST_ADD` min=-83857671.68, max=4082695119.29, zero=273972, negative=10, NULL=0；`DISPOSAL_TFA_ADD` min=-6298432310.98, max=23209859906.28, zero=273808, negative=80, NULL=0
...
|------|----------|------|--------------|----------|
| `UPDATE_DATE` 使用 `1970-01-01` 表示缺失/未发生日期 | 中 | 449 行 | 在 staging 中按字段语义转为 NULL 或保留并显式标注 | 是否作为业务缺失值需在对应 model 中确认 |
| `SECURITY_CODE` 只有 6 位本地代码 | 中 | 274016/274016 行 | 仅作为 `security_local_code`；不可单独推出交易所 | 需要其他字段或主数据补齐交易所 |
| `NETCASH_OPERATE` 存在负值 | 低 | 94764 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `SALES_SERVICES` 存在负值 | 低 | 1420 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `DEPOSIT_INTERBANK_ADD` 存在负值 | 低 | 622 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `LOAN_PBC_ADD` 存在负值 | 低 | 110 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `OFI_BF_ADD` 存在负值 | 低 | 173 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `RECEIVE_ORIGIC_PREMIUM` 存在负值 | 低 | 12 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `RECEIVE_REINSURE_NET` 存在负值 | 低 | 32 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `INSURED_INVEST_ADD` 存在负值 | 低 | 10 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
| `DISPOSAL_TFA_ADD` 存在负值 | 低 | 80 行 | 不在 staging 中过滤；保留并按财务/行情语义解释 | 指标口径解释放到具体业务模型 |
...
- `select count() from fleur_raw.eastmoney__cashflow_sq`：274,016
- 日期字段范围：`REPORT_DATE`: 2000-12-31 至 2026-03-31，NULL 0 行；`NOTICE_DATE`: 2001-03-15 至 2026-05-15，NULL 0 行；`UPDATE_DATE`: 1970-01-01 至 2026-06-02，NULL 0 行，`1970-01-01` 占位 449 行
- 证券代码格式：`SECUCODE`: canonical 后缀 274016/274016，供应商前缀 0/274016，纯数字 0/274016，空值 0/274016；`SECURITY_CODE`: canonical 后缀 0/274016，供应商前缀 0/274016，纯数字 274016/274016，空值 0/274016
- 候选键重复：未发现重复
- 枚举 top values：`SECUCODE`: `600019.SH`(97), `000402.SZ`(97), `000962.SZ`(95), `600819.SH`(95), `600280.SH`(95), `600640.SH`(95), `600708.SH`(95), `000929.SZ`(95)；`SECURITY_CODE`: `600019`(97), `000402`(97), `000951`(95), `600302`(95), `000025`(95), `000410`(95), `000798`(95), `000619`(95)；`SECURITY_NAME_ABBR`: `东方明珠`(142), `百联股份`(127), `宝钢股份`(97), `金融街`(97), `*ST广糖`(95), `云维股份`(95), `国电电力`(95), `中国重汽`(95)；`ORG_CODE`: `10004127`(160), `10004106`(156), `10116535`(126), `10004293`(116), `10002266`(97), `10633808`(97), `10005578`(95), `10002608`(95)；`ORG_TYPE`: `通用`(274016)；`REPORT_TYPE`: `一季度`(71797), `三季度`(68255), `四季度`(67850), `二季度`(66114)；`REPORT_DATE_NAME`: `2026一季度`(5099), `2025一季度`(5088), `2025四季度`(5084), `2024一季度`(5073), `2025三季度`(5060), `2025二季度`(5051), `2024三季度`(5034), `2024四季度`(5020)；`SECURITY_TYPE_CODE`: `058001001`(273993), `058001008`(23)
- 数值范围摘要：`NETCASH_OPERATE` min=-122529899000.0, max=155272000000.0, zero=33, negative=94764, NULL=0；`NETPROFIT` min=0.0, max=0.0, zero=274016, negative=0, NULL=0；`SALES_SERVICES` min=-42322221929.59, max=959495000000.0, zero=1013, negative=1420, NULL=0；`DEPOSIT_INTERBANK_ADD` min=-87592360060.9, max=102877887953.83, zero=272556, negative=622, NULL=0；`LOAN_PBC_ADD` min=-5080000000.0, max=3140000000.0, zero=273773, negative=110, NULL=0；`OFI_BF_ADD` min=-19095030043.44, max=12402359588.77, zero=273621, negative=173, NULL=0；`RECEIVE_ORIGIC_PREMIUM` min=-283791773.13, max=8374326598.0, zero=273699, negative=12, NULL=0；`RECEIVE_REINSURE_NET` min=-269841134.34, max=459643509.88, zero=273951, negative=32, NULL=0；`INSURED_INVEST_ADD` min=-83857671.68, max=4082695119.29, zero=273972, negative=10, NULL=0；`DISPOSAL_TFA_ADD` min=-6298432310.98, max=23209859906.28, zero=273808, negative=80, NULL=0
