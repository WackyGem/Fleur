...
2. 更新 `docs/architecture/racingline.md`，删除 Step 3 展示 raw values、完整 debug analysis 的职责表述。
3. 如新增 timeline 或 condition_hits API，更新 `docs/architecture/rearview.md`。
