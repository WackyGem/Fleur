...
关联设计：`docs/RFC/archive/0026-racingline-strategy-pool-preview-step3.md`, `docs/issues/archive/debt/0004-2026-06-22-strategies-step3-implemennt-drift.md`, `docs/plans/archive/0048-racingline-strategy-step3-drift-remediation-plan.md`
...
2. `docs/architecture/racingline.md`：加入 Step 3 板块、量柱、动态窗口和权重微调事实。
3. `docs/architecture/rearview.md`：如新增 `security_board` 或 `include_quote_rows` contract，同步 API 事实。
4. `docs/architecture/dbt_layer/fleur_marts/mart_stock_basic_snapshot.md`：记录 `security_board` 字段。
