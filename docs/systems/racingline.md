...
状态：单一正式前端工作台已落到 `app/racingline/`；Step 4 到 Step 5 回测 handoff 已改为 create accepted 后进入状态页（2026-06-25）；Step 5 succeeded 首屏已切到 Rearview overview compact endpoint，HTTP live 计时和前端质量门禁已通过（2026-06-26）
