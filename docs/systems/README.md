...
本目录按系统和产品线组织 mono-fleur 的当前事实地图。新需求先走 `docs/intake/`，再回到本目录确认当前事实。系统地图不替代 `ADR/`、`RFC/`、`plans/`、`jobs/`、`design/` 或 `references/`；这些目录仍按文档生命周期和事实类型保存权威内容。

使用方式：

1. 新需求先从 [../intake/README.md](../intake/README.md) 选择领域入口。
...
| 系统 | 当前代码根 | 需求入口 | 事实地图 | 角色 |
|---|---|---|---|---|
| 数据平台 | `pipeline/scheduler/`、`pipeline/elt/` | [../intake/data-platform.md](../intake/data-platform.md) | [data-platform.md](data-platform.md) | Dagster 编排、S3 Parquet、ClickHouse raw sync、dbt 建模 |
...
| Racingline | `app/racingline/` | [../intake/racingline.md](../intake/racingline.md) | [racingline.md](racingline.md) | Rearview 策略研究前端工作台 |
...
- 新增系统、应用、服务或长期子域时，同时新增对应 `docs/intake/*.md` 需求入口。
