...
| 文档 | 用途 |
|---|---|
| [../architecture/scheduler-architecture.md](../architecture/scheduler-architecture.md) | 当前 scheduler 架构和主要数据流 |
| [../architecture/scheduler-module-boundaries.md](../architecture/scheduler-module-boundaries.md) | scheduler 模块职责、依赖方向和禁止模式 |
| [../design/README.md](../design/README.md) | dbt 模型设计入口 |
...
2. Dagster jobs reports 与系统地图之间是否需要自动索引。
