...
- `src/scheduler/defs/definitions.py` 注册 `SOURCE_BUNDLES` 里的 source assets、`CLICKHOUSE_RAW_ASSETS`、backfill jobs、daily source-to-marts job/schedule、portfolio live job/schedule、Slack failure sensor 和 resources。
