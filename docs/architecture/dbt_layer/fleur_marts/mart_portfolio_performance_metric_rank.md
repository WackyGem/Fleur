...
- Intermediate 设计：`docs/architecture/dbt_layer/fleur_intermediate/int_portfolio_performance_metric.md`
- Intermediate 设计：`docs/architecture/dbt_layer/fleur_intermediate/int_portfolio_performance_metric_status.md`
