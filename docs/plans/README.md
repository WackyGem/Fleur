...
| [0045](0045-racingline-strategy-selection-step1-gap-closure-plan.md) | Proposed | Racingline 策略选股 Step 1 缺口填补：趋势前值字段、Rearview metric catalog/crossing/explain 和 `racingline_new` API vertical slice |
