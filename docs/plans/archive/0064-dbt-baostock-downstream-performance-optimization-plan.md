# Plan 0064: BaoStock dbt 下游存量作业性能优化实施计划
...
- 输出至少一份优化后运行报告，对比 RFC 0038 的 `374.86s` baseline。
...
目标：把 RFC 0038 的“raw latest year 成功后触发相关 int/mart 全量重建”落到存量 Dagster 作业关系中。
