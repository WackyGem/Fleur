...
- 支持的 contract Parquet 类型包括：`string`、`date32[day]`、`date32`、`bool`、`int8`、`int32`、`int64`、`float64`、`double`、`timestamp[s]`、`timestamp[s, tz=UTC]`、`timestamp[ns]`、`timestamp[ns, tz=UTC]`、`time32[ms]`。
