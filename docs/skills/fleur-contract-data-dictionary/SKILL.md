...
- Parquet schema adapter 设计：`docs/RFC/0011-contract-driven-parquet-schema-adapter.md`
- Parquet schema adapter 实施计划：`docs/plans/0022-contract-driven-parquet-schema-adapter-implementation-plan.md`
