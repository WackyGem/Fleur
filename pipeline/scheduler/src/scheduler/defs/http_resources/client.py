...
class AioHttpClient:
    ...
    async def request_text(self, request: HttpRequest) -> HttpTextResponse:
        return await self._request_with_retries(request, decode_json=False)

    async def request_json_object(self, request: HttpRequest) -> Mapping[str, object]:
        response = await self._request_with_retries(request, decode_json=True)
    ...
    async def _send_once(self, request: HttpRequest) -> HttpTextResponse:
