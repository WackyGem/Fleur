    ...
    select
        *,
        multiIf(
            ...
            security_type_code = 1 and exchange_code = 'SH' and startsWith(security_local_code, '60'), 'sse_main_board',
            security_type_code = 1 and exchange_code = 'SZ' and startsWith(security_local_code, '30'), 'chinext',
            security_type_code = 1 and exchange_code = 'SZ' and startsWith(security_local_code, '00'), 'szse_main_board',
            null
